...
namespace project.Views.DetailViews.SettingsViews
{
	...
	{  
        ...
        public SettingsScreen() 
		{
            ...
            Title = Constant.SettingsScreenTitle;
		}
        ...
        {
            base.OnDisappearing();
            var action = await DisplayAlert("Settings", "Do you want to save the settings?", "Okay", "Cancel");
            if(action)
                SaveSettings();
        }
